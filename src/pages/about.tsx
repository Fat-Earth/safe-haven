    ...
    <div className='h-full w-full'>
        ...
        <div className='flex flex-col w-full h-full bg-primary items-start pt-32'>
            ...
            <div className='grid grid-cols-2 gap-8 w-10/12 mx-auto my-10 place-items-center h-full ' >
                ...
                <div className=' w-2/3 flex-col place-self-end rounded-lg aspect-square h-full flex items-center justify-center shadow-lg shadow-neutral-400'>
                ...
                <div className=' w-2/3 flex-col rounded-lg place-self-start aspect-square h-full flex items-center justify-center shadow-lg shadow-neutral-400'>
